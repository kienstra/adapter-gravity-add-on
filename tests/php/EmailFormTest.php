 ...
 * @package AdapterGravityAddOn
 */
class EmailFormTest extends AdapterAddOnTest {
	...
	public function test_init() {
		$this->instance->init();
		$this->assertEquals( 10, has_filter( 'gform_pre_render', [ $this->instance, 'conditionally_display_form_horizontally' ] ) );
		$this->assertEquals( 100, has_filter( 'the_content', [ $this->instance, 'conditionally_append_form' ] ) );
		$this->assertEquals( 12, has_filter( 'gform_field_content', [ $this->instance, 'set_class_of_input' ] ) );
		$this->assertEquals( 10, has_filter( 'gform_submit_button', [ $this->instance, 'submit_button' ] ) );
	}
	...
	public function test_conditionally_display_form_horizontally() {
		...
		$form_with_pre_existing_class_not_horizontal = [
			$horizontal_setting                => '',
			$this->instance->css_class_setting => $pre_existing_class,
		];
